    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-lg font-bold text-slate-900">{editingId ? "Modifier la session" : "Ajouter une session"}</h2>
          {editingId && (
      ...
      <div className="card">
        <h2 className="mb-4 text-lg font-bold text-slate-900">Sessions ({sessions.length})</h2>
        {sessions.length === 0 ? (
